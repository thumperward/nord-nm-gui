...
class MainWindow(QtWidgets.QMainWindow):
    ...
    def main_ui_layout(self):
        self.title_widget = QtWidgets.QHBoxLayout()
        self.title_widget.setObjectName("self.title_widget")
        self.title_widget.addItem(self.spacer_item_1)
        self.title_widget.addWidget(self.title_label)
        self.title_widget.addItem(self.spacer_item_2)
        self.country_list_widget = QtWidgets.QVBoxLayout()
        self.country_list_widget.setObjectName("self.country_list_widget")
        self.country_list_widget.addWidget(self.country_list_label)
        self.country_list_widget.addWidget(self.line_1)
        self.country_list_widget.addWidget(self.country_list)
        self.check_box_widget = QtWidgets.QVBoxLayout()
        self.check_box_widget.setObjectName("self.check_box_widget")
        self.check_box_widget.addWidget(self.auto_connect_box)
        self.check_box_widget.addWidget(self.mac_changer_box)
        self.check_box_widget.addWidget(self.kill_switch_button)
        self.dropdowns_widget = QtWidgets.QVBoxLayout()
        self.dropdowns_widget.setObjectName("self.dropdowns_widget")
        self.dropdowns_widget.addWidget(self.server_type_select)
        self.dropdowns_widget.addWidget(self.connection_type_select)
        self.options_widget = QtWidgets.QHBoxLayout()
        self.options_widget.setObjectName("self.options_widget")
        self.options_widget.addLayout(self.check_box_widget)
        self.options_widget.addLayout(self.dropdowns_widget)
        self.options_widget.addItem(QtWidgets.QSpacerItem(
            40, 20, QtWidgets.QSizePolicy.MinimumExpanding, QtWidgets.QSizePolicy.Minimum
        ))
        self.options_widget.addWidget(self.connect_button)
        self.options_widget.addWidget(self.disconnect_button)
        self.servers_widget = QtWidgets.QVBoxLayout()
        self.servers_widget.setObjectName("self.servers_widget")
        self.servers_widget.addWidget(self.central_widget_label)
        self.servers_widget.addWidget(self.line_2)
        self.servers_widget.addWidget(self.server_list)
        self.main_ui_grid = QtWidgets.QGridLayout(self.central_widget_)
        self.main_ui_grid.setObjectName("self.main_ui_grid")
        self.main_ui_grid.addLayout(self.title_widget, 0, 0, 1, 2)
        self.main_ui_grid.addLayout(self.country_list_widget, 1, 0, 1, 1)
        self.main_ui_grid.addLayout(self.options_widget, 2, 0, 1, 2)
        self.main_ui_grid.addLayout(self.servers_widget, 1, 1, 1, 1)
